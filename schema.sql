...
ALTER TABLE shop_suppliers ADD COLUMN shop_id int;
ALTER TABLE shop_suppliers ADD COLUMN supplier_id int;
...
CREATE TABLE IF NOT EXISTS supplier_orders_transaction(
  ...
  FOREIGN KEY supply_order_id REFERENCES supplier_orders ON DELETE CASCADE
) ENGINE=InnoDB;
ALTER TABLE supplier_orders_transaction ADD COLUMN supply_order_id int;
ALTER TABLE supplier_orders_transaction ADD CONSTRAINT fk_supplier_ordering_transaction FOREIGN KEY(supply_order_id) REFERENCES supplier_orders(supply_order_id);
...
ALTER TABLE order_transaction ADD COLUMN order_item_id int;
ALTER TABLE order_transaction ADD CONSTRAINT fk_cust_order_trans FOREIGN KEY(order_item_id) REFERENCES order_cart(order_item_id);
...
ALTER TABLE customer_transactions ADD CONSTRAINT fk_cust_redeem_trans FOREIGN KEY(order_id) REFERENCES order_transaction(order_id);
